...
export function calendar(options) {
    const { dayFormat, fullDateFormat, locale = 'en-US', selectedDate, disabledDates = [], disabledDays = [], firstDayOfWeek = 0, max, min, showWeekNumber = false, weekLabel = 'Week', weekNumberType = 'first-4-day-week', } = options || {};
